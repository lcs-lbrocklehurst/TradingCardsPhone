...
let MichealPezzetta = Card(name: "Micheal Pezzetta", image: "Pezzetta", height: "6'1", weight: "201", shoots: "left", birthdate: "03/12/1998", gamesPlayed: "81", goals: "8", assists: "9", points: "17", penaltyMinutes: "112", description: "He is a classic underdog story: a sixth-round pick in the 2016 draft who has battled his way up to the NHL. Plays with lots of heart, if not lots of skill. Has never been a big scorer, even in junior hockey, and has had to scratch and claw his way for everything he gets. Will skate through a wall (or an opponent), get in front of shots and stand up for his teammates.")

let NickSuzuki = Card(name: "Nick Suzuki", image: "Suzuki", height: "5'11", weight: "208", shoots: "right", birthdate: "08/10/1999", gamesPlayed: "258", goals: "65", assists: "116", points: "181", penaltyMinutes: "78", description: "A smart offensive center who thinks the game at a fast pace and makes very good decisions on a consistent basis. Though he may not be the biggest player on the ice, Suzuki plays a thick, sturdy game and is hard to knock off the puck, especially when he has his feet moving. He's an excellent skater that knows his own game well. Skilled with the puck and has a high level of hockey sense. This blend of talent and work ethic is hard to come by, invaluable in the long run.")
